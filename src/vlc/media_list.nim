...
proc add_media(ml: MediaList, m: Media ): int = ml.media_list_add_media(m)
proc insert_media(ml: MediaList, m: Media, pos: int ): int = ml.media_list_insert_media(m, pos.cint)
proc remove_index(ml: MediaList, pos: int ): int = ml.media_list_remove_index(pos.cint)
proc count(ml: MediaList): int = ml.media_list_count()
proc item_at_index(ml: MediaList, pos: int ): Media = result.impl = ml.media_list_item_at_index(pos.cint)
proc index_of_item(ml: MediaList, m: Media ): int = ml.media_list_index_of_item(m)
